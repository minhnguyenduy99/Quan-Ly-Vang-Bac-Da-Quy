...
namespace UIProject.ViewModels.LayoutViewModels
{
    ...
    public class DialogWindowViewModel : BaseWindowViewModel
    {
        ...
        {
            get => yesCmd ?? (yesCmd = new BaseCommand(() => DialogResult = DialogResult.Yes));
            set => yesCmd = value;
        }
        ...
        {
            get => noCmd ?? (noCmd = new BaseCommand(() => DialogResult = DialogResult.No));
            set => noCmd = value;
        }
        ...
        {
            get => cancelCmd ?? (cancelCmd = new BaseCommand(() => DialogResult = DialogResult.Cancel));
            set => cancelCmd = value;
        }
        ...
        {
            get => okCmd ?? (okCmd = new BaseCommand(() => DialogResult = DialogResult.OK));
            set => okCmd = value;
        }
    }

    public class DialogWindowViewModel<T> : BaseWindowViewModel<T> where T:BaseDataModel
    {
        #region Default content in the buttons of Dialog Window
        public const string DEFAULT_YES_TEXT = "Có";
        public const string DEFAULT_NO_TEXT = "Không";
        ...
        public DialogWindowViewModel(T dataModel):base(dataModel)
        {
            // Set up default contents of buttons in dialog window
            yesText = DEFAULT_YES_TEXT;
            noText = DEFAULT_NO_TEXT;
